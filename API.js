    document.addEventListener('DOMContentLoaded', function () {
      fetch('https://helphub.codechazer.org/api/featured-campaigns')
              ...
              <div class="col-md-4">
                <div class="card campaigns mb-4 shadow-sm">
                  <a href="${campaign.link}" class="p-relative">
                    ...
                    <img class="card-img-top" src="	https://helphub.codechazer.org/public/campaigns/small/${campaign.small_image}" alt="image">
                  </a>
                  <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                      <span class="text-truncate">
                        <img src="https://helphub.codechazer.org/public/avatar/default.jpg" width="25" height="25" class="rounded-circle avatar-campaign">
